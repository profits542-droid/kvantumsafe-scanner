...
func getTranslation(key, lang string) string {
	translations := map[string]map[string]string{
		...
		"build_desc": {
			...
			"ar": "عمل منصة Render السحابية كأكثر حكم صارم في تقييم بنيتنا التكنولوجية. وهي تستخدم مترجم Go الرسمي الأصلي. إن وجود حالة الإنتاج الرسمية Live يؤكد أن نواة النظام الموزع خالية تمامًا من أي أخطاء برمجية أو عدم تطابق в أنواع البيانات.",
		},
		"saas_title": {
