...
func GetPerimeterReportHTML(lang string) string {
	return "<html><body style='font-family:sans-serif;padding:40px;'><h2>Audit Report (" + lang + ")</h2><p>Vulnerability scan completed / Сканирование завершено.</p><p><a href='/?lang=" + lang + "'>← Back / Назад</a></p></body></html>"
}

func GetBillingPageHTML(clientName, lang string) string {
	return "<html><body style='font-family:sans-serif;padding:40px;'><h2>Billing Panel (" + lang + ")</h2><p>Organization: " + clientName + "</p><p><a href='/?lang=" + lang + "'>← Back / Назад</a></p></body></html>"
}
