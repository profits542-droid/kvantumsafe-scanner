...
// Мультиязычная база данных текстов (Словарь локализации)
func getTranslation(key, lang string) string {
	translations := map[string]map[string]string{
		...
		"scan_desc": {
			"ru": "Введите адрес домена вашей организации (например, <i>bank.kg</i>), чтобы запустить внешнее сканирование защитных шлюзов на предмет устаревших конфигураций:",
			"en": "Enter your organization's domain address (e.g., <i>bank.com</i>) to launch an external scan of protective gateways for outdated configurations:",
			"kz": "Ескірген конфигурацияларды анықтау үшін ұйымыңыздың домендік мекенжайын енгізіңіз (мысалы, <i>bank.kz</i>):",
			"ar": "أدخل عنوان نطاق مؤسستك (مثل <i>bank.com</i>) لبدء فحص خارجي لبوابات الحماية بحثًا عن الإعدادات القديمة:",
		},
		"scan_btn": {
			"ru": "Запустить аудит",
			"en": "Launch Audit",
		...
		"p1_desc": {
			...
			"ar": "يعمل البرنامج كمدقق رقمي يقظ. يقوم بفحص منافذ النظام الخارجية، والتحقق من بوابات الشبكة للتطبيقات المصرفية، والتعرف الفوري على الإصدارات القديمة من البروتوكولات الآمنة (مثل إصدارات OpenSSL الضعيفة)، مما يمنع اعتراض البيانات من الخارج.",
		},
		"p2_title": {
