...
func GetFullDownloadOffer(lang string) string {
	// Универсальный B2B-оффер с жестким включением КНР-протоколов и зачисткой слова на букву 'Ш'
	return "ОФИЦИАЛЬНАЯ ТЕХНИЧЕСКАЯ СПЕЦИФИКАЦИЯ И ТАРИФНАЯ СЕТКА КОРПОРАТИВНОГО B2B-ОФФЕРА\n" +
		...
		"3. ТАРИФ «QUANTUM WEB3» (МАКСИМАЛЬНАЯ ЗА ЗАЩИТА / КВАНТОВОЕ БЕССМЕРТИЕ) — 35 000 долларов США / год\n" +
